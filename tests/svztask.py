    ...
    async def handle_tasks(self, task_id, work_queue):
        while not work_queue.empty():
            ...
            try:
                ...
                print('status',task_id,task_status)
            except Exception as e:
...
if __name__ == '__main__':
    async_example = AsnycGrab(['http://edmundmartin.com', 'https://www.udemy.com', 'https://github.com/', 'https://zhangslob.github.io/', 'https://www.zhihu.com/'], 5)
